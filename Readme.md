...
| Authenticator Auto-Launch            | ON or OFF                                                                                                                                           | When **ON**, the login page opens the Gematik Authenticator immediately and skips the confirmation modal. When **OFF** (default), the modal is shown and the user must confirm before the app is launched.                                                                          |
