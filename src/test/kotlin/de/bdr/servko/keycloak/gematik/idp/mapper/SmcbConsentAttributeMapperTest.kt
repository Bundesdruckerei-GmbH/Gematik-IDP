...
internal class SmcbConsentAttributeMapperTest {
    ...
    private val objectUnderTest = SmcbConsentAttributeMapper()
    ...
    @Test
    fun getId() {
        assertThat(objectUnderTest.id).isEqualTo("gematik-idp-authenticator-smcb-consent-attribute-mapper")
    }

    @Test
    fun getHelpText() {
        assertThat(objectUnderTest.helpText)
            .isEqualTo("Save client consent for SMCB from Authenticator, into the specified user attribute.")
    }

    @Test
    fun getDisplayType() {
        assertThat(objectUnderTest.displayType).isEqualTo("Gematik Authenticator SMCB Consent Attributes")
    }
